...
public sealed class MetricsController(MetricsService metrics) : ControllerBase
{
    ...
    [SwaggerOperation(Summary = "Total de workshops por colaborador", Description = "Conta workshops distintos para todos os colaboradores, incluindo zero para quem não tem presença. Ordena por nome e ID; banco vazio retorna [].")]
    ...
    [SwaggerOperation(Summary = "Total de colaboradores por workshop", Description = "Inclui workshops sem ata ou participantes com zero. Ordena por nome e ID; banco vazio retorna [].")]
